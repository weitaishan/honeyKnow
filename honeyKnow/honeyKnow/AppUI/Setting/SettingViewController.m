...
//{
//    menu.switchValue = !([IMAPlatform sharedInstance].localConfig.environment == 1);
//    [[IMAPlatform sharedInstance].localConfig chageEnvTo:menu.switchValue?1:0];
//    UIAlertView *alert = [UIAlertView bk_showAlertViewWithTitle:@"提示" message:@"切换环境，下次启动时才生效。" cancelButtonTitle:@"取消" otherButtonTitles:@[@"确定"] handler:nil];
//    [alert show];
//}
//
//- (void)onSwitchConsoleLog:(RichCellMenuItem *)menu cell:(UITableViewCell *)cell
//{
//    menu.switchValue = ![IMAPlatform sharedInstance].localConfig.enableConsoleLog;
//    [[IMAPlatform sharedInstance].localConfig chageEnableConsoleTo:menu.switchValue];
//    UIAlertView *alert = [UIAlertView bk_showAlertViewWithTitle:@"提示" message:@"修改控制台日志，下次启动时才生效。" cancelButtonTitle:@"取消" otherButtonTitles:@[@"确定"] handler:nil];
//    [alert show];
//}
//
//
