...
@interface WTSAlertViewTools()
@property (nonatomic, copy) AlertViewBlock block;

@end

@implementation WTSAlertViewTools

#pragma mark - 对外方法
+ (WTSAlertViewTools *)shareInstance {
    static WTSAlertViewTools *tools = nil;
